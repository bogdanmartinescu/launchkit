...
export function EmailHero() {
  ...
  const bullets =
    section.bullets.length > 0
      ? section.bullets
      : ["🎁 Instant download", "🔄 Updated monthly", "🔓 No paywall, ever"];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-3xl mx-auto text-center space-y-10">
          ...
          >
            ...
            {section.description && (
              <p className="text-slate-400 text-xl leading-relaxed">{section.description}</p>
            )}
            ...
            {section.socialProofLabel && (
              <div className="flex items-center justify-center gap-4 flex-wrap">
                ...
                <span className="text-slate-400 text-sm">{section.socialProofLabel}</span>
              </div>
            )}
          </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="glass rounded-2xl p-4">
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    >
                      {loading ? "Sending…" : section.ctaPrimary.label || leadMagnet.title}
